...
from fairseq.dataclass.utils import convert_omegaconf_to_namesapce
...
@dataclass
class RobertaEncDecConfig(TransformerConfig):
    ...
    hack_layernorm_embedding: bool = field(default=False)
    pretrained_mlm_checkpoint: Optional[str] = field(default=None)
    load_pretrained_mlm_checkpoint: Optional[str] = field(default=None)


@register_model("roberta_enc_dec", dataclass=RobertaEncDecConfig)
class RobertaEncDecModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.pretrained_mlm_checkpoint:
            ...
            state = fairseq.checkpoint_utils.load_checkpoint_to_cpu(args.pretrained_mlm_checkpoint,
                                                                    arg_overrides=arg_overrides)
            roberta_enc.load_state_dict(
