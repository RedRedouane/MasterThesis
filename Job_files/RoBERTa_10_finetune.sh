...
#SBATCH --job-name=RoBERTa_10
#SBATCH --output=/home/dahmanir/lisa/Jobberts/Final/Out_files/RoBERTa_10_finetune.out
...
# Run your code
fairseq-hydra-train -m --config-dir lisa/Configs/Final/ --config-name RoBERTa_10_finetune
